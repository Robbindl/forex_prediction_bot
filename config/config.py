...
BROKER_MIN_SECONDS_BETWEEN_ENTRIES = _parse_float(os.getenv("BROKER_MIN_SECONDS_BETWEEN_ENTRIES", "300"), 300.0)
BROKER_MAX_NEW_TRADES_PER_CYCLE = _parse_int(os.getenv("BROKER_MAX_NEW_TRADES_PER_CYCLE", "1"), 1)
BROKER_SUPPORT_CHECK_POOL_LIMIT = _parse_int(os.getenv("BROKER_SUPPORT_CHECK_POOL_LIMIT", "8"), 8)
BROKER_MIN_EXECUTION_CONFIDENCE = _parse_float(os.getenv("BROKER_MIN_EXECUTION_CONFIDENCE", "0.64"), 0.64)
BROKER_MIN_EXECUTION_OPPORTUNITY_SCORE = _parse_float(os.getenv("BROKER_MIN_EXECUTION_OPPORTUNITY_SCORE", "0.66"), 0.66)
BROKER_MIN_EXECUTION_SETUP_QUALITY = _parse_float(os.getenv("BROKER_MIN_EXECUTION_SETUP_QUALITY", "0.50"), 0.50)
BROKER_MIN_EXECUTION_ALIGNMENT = _parse_float(os.getenv("BROKER_MIN_EXECUTION_ALIGNMENT", "0.50"), 0.50)
BROKER_MAX_EXECUTION_CONFLICTS = _parse_int(os.getenv("BROKER_MAX_EXECUTION_CONFLICTS", "0"), 0)
BROKER_MIN_FINAL_TP_RR = _parse_float(os.getenv("BROKER_MIN_FINAL_TP_RR", "1.0"), 1.0)
IG_MIN_ATTACHED_ORDER_RR = _parse_float(
    os.getenv("IG_MIN_ATTACHED_ORDER_RR", os.getenv("BROKER_MIN_FINAL_TP_RR", "1.0")),
    1.0,
)
BROKER_MAX_OPEN_POSITIONS = _parse_int(os.getenv("BROKER_MAX_OPEN_POSITIONS", "3"), 3)
BROKER_MAX_OPEN_POSITIONS_PER_CATEGORY = _parse_int(os.getenv("BROKER_MAX_OPEN_POSITIONS_PER_CATEGORY", "1"), 1)
BROKER_MAX_SAME_DIRECTION_POSITIONS = _parse_int(os.getenv("BROKER_MAX_SAME_DIRECTION_POSITIONS", "2"), 2)
BROKER_PORTFOLIO_EMERGENCY_FLATTEN_ENABLED = _parse_bool(
    os.getenv("BROKER_PORTFOLIO_EMERGENCY_FLATTEN_ENABLED", "true"),
    True,
)
BROKER_PORTFOLIO_MAX_FLOATING_LOSS_PCT = _parse_float(
    os.getenv("BROKER_PORTFOLIO_MAX_FLOATING_LOSS_PCT", "20.0"),
    20.0,
)
BROKER_MAX_OPEN_POSITION_LOSS_PCT = _parse_float(
    os.getenv("BROKER_MAX_OPEN_POSITION_LOSS_PCT", "20.0"),
    20.0,
)
BROKER_PORTFOLIO_MIN_LOSING_POSITIONS = _parse_int(
    os.getenv("BROKER_PORTFOLIO_MIN_LOSING_POSITIONS", "3"),
    3,
)
BROKER_PORTFOLIO_COOLDOWN_MINUTES = _parse_float(
...
BROKER_DAILY_MAX_LOSS_PCT = _parse_float(os.getenv("BROKER_DAILY_MAX_LOSS_PCT", "25.0"), 25.0)
BROKER_DAILY_PROFIT_TARGET_PCT = _parse_float(os.getenv("BROKER_DAILY_PROFIT_TARGET_PCT", "30.0"), 30.0)
...
DUKASCOPY_LIVE_DEPTH_KEEPALIVE_ENABLED = _parse_bool(
    os.getenv("DUKASCOPY_LIVE_DEPTH_KEEPALIVE_ENABLED", "false"),
    False,
)
DUKASCOPY_LIVE_DEPTH_KEEPALIVE_SYMBOL = (
    os.getenv("DUKASCOPY_LIVE_DEPTH_KEEPALIVE_SYMBOL", "EUR/USD").strip() or "EUR/USD"
)
DUKASCOPY_LIVE_DEPTH_KEEPALIVE_AMOUNT = _parse_float(
    os.getenv("DUKASCOPY_LIVE_DEPTH_KEEPALIVE_AMOUNT", "0.001"),
    0.001,
)
DUKASCOPY_LIVE_DEPTH_KEEPALIVE_INTERVAL_DAYS = _parse_int(
    os.getenv("DUKASCOPY_LIVE_DEPTH_KEEPALIVE_INTERVAL_DAYS", "7"),
    7,
)
DUKASCOPY_LIVE_DEPTH_KEEPALIVE_HOLD_SECONDS = _parse_int(
    os.getenv("DUKASCOPY_LIVE_DEPTH_KEEPALIVE_HOLD_SECONDS", "15"),
    15,
)
DUKASCOPY_LIVE_DEPTH_KEEPALIVE_STATE_PATH = Path(
    os.getenv("DUKASCOPY_LIVE_DEPTH_KEEPALIVE_STATE_PATH", "data/dukascopy_keepalive_state.txt")
)
DUKASCOPY_LIVE_DEPTH_KEEPALIVE_ALLOW_LIVE = _parse_bool(
    os.getenv("DUKASCOPY_LIVE_DEPTH_KEEPALIVE_ALLOW_LIVE", "false"),
    False,
)
...
NEWS_SENTIMENT_EXECUTION_ENABLED = os.getenv("NEWS_SENTIMENT_EXECUTION_ENABLED", "false").lower() == "true"
...
ASSET_EDGE_LOOKBACK_DAYS = int(os.getenv("ASSET_EDGE_LOOKBACK_DAYS", "14"))
ASSET_EDGE_MIN_SAMPLES = int(os.getenv("ASSET_EDGE_MIN_SAMPLES", "4"))
ASSET_EDGE_MAX_RISK_BONUS = float(os.getenv("ASSET_EDGE_MAX_RISK_BONUS", "0.18"))
ASSET_EDGE_MAX_RISK_PENALTY = float(os.getenv("ASSET_EDGE_MAX_RISK_PENALTY", "0.20"))
BOOK_EDGE_LOOKBACK_DAYS = int(os.getenv("BOOK_EDGE_LOOKBACK_DAYS", "14"))
BOOK_EDGE_MIN_SAMPLES = int(os.getenv("BOOK_EDGE_MIN_SAMPLES", "8"))
BOOK_EDGE_MAX_RISK_BONUS = float(os.getenv("BOOK_EDGE_MAX_RISK_BONUS", "0.16"))
BOOK_EDGE_MAX_RISK_PENALTY = float(os.getenv("BOOK_EDGE_MAX_RISK_PENALTY", "0.18"))
WINNER_ADDON_ENABLED = os.getenv("WINNER_ADDON_ENABLED", "true").lower() == "true"
WINNER_ADDON_MIN_PROGRESS_RR = float(os.getenv("WINNER_ADDON_MIN_PROGRESS_RR", "1.5"))
WINNER_ADDON_MIN_CONFIDENCE = float(os.getenv("WINNER_ADDON_MIN_CONFIDENCE", "0.66"))
WINNER_ADDON_MIN_QUALITY_SCORE = float(os.getenv("WINNER_ADDON_MIN_QUALITY_SCORE", "62.0"))
WINNER_ADDON_SIZE_FRACTION = float(os.getenv("WINNER_ADDON_SIZE_FRACTION", "0.45"))
WINNER_ADDON_MAX_POSITIONS_PER_ASSET = int(os.getenv("WINNER_ADDON_MAX_POSITIONS_PER_ASSET", "2"))
ROBBIE_SCHEDULER_ENABLED = os.getenv("ROBBIE_SCHEDULER_ENABLED", "true").lower() == "true"
ROBBIE_SCHEDULER_POLL_SECONDS = float(os.getenv("ROBBIE_SCHEDULER_POLL_SECONDS", "15"))
ROBBIE_DEFAULT_WEEKLY_REPORT_WEEKDAY = str(os.getenv("ROBBIE_DEFAULT_WEEKLY_REPORT_WEEKDAY", "friday") or "friday").strip().lower()
ROBBIE_DEFAULT_WEEKLY_REPORT_TIME = str(os.getenv("ROBBIE_DEFAULT_WEEKLY_REPORT_TIME", "18:00") or "18:00").strip()
...
GOVERNANCE_RECENT_GUARD_ENABLED = os.getenv("GOVERNANCE_RECENT_GUARD_ENABLED", "true").lower() == "true"
GOVERNANCE_RECENT_GUARD_DAYS = int(os.getenv("GOVERNANCE_RECENT_GUARD_DAYS", "14"))
GOVERNANCE_RECENT_GUARD_MIN_SAMPLES = int(os.getenv("GOVERNANCE_RECENT_GUARD_MIN_SAMPLES", "4"))
GOVERNANCE_RECENT_GUARD_MAX_LOSS_USD = float(os.getenv("GOVERNANCE_RECENT_GUARD_MAX_LOSS_USD", "-75.0"))
GOVERNANCE_RECENT_GUARD_ASSET_MIN_AVG_R = float(
    os.getenv("GOVERNANCE_RECENT_GUARD_ASSET_MIN_AVG_R", "-0.12")
)
GOVERNANCE_RECENT_GUARD_PLAYBOOK_MIN_AVG_R = float(
    os.getenv("GOVERNANCE_RECENT_GUARD_PLAYBOOK_MIN_AVG_R", "-0.08")
)
GOVERNANCE_RECENT_GUARD_SESSION_MIN_AVG_R = float(
    os.getenv("GOVERNANCE_RECENT_GUARD_SESSION_MIN_AVG_R", "-0.18")
)
GOVERNANCE_RECENT_GUARD_MAX_PREMATURE_STOP_RATE = float(
    os.getenv("GOVERNANCE_RECENT_GUARD_MAX_PREMATURE_STOP_RATE", "0.50")
)
